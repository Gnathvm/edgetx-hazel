...
#elif defined(GN_RELEASE)
#define DISPLAY_VERSION "-GN"
...
#define DISPLAY_VERSION
  ...
  #if defined(RADIOMASTER_RELEASE) || defined(JUMPER_RELEASE) || defined(GN_RELEASE)
...
#elif defined(RADIOMASTER_RELEASE) || defined(GN_RELEASE)
